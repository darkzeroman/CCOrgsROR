...
event = Event.create(:title=>'First Event', :description => 'Description', :location=>'Klaus', 
...
#attr_accessible :email, :first_name, :last_name, :gt_num_id, :gt_user_id, :is_admin, :password

admin = User.create(:first_name => 'Vidhur', :last_name => 'Vohra', :gt_user_id => 'admin', 
	:password => 'password', :email => "blah@lol.com", :gt_num_id => "9023", :is_admin => true)
new_user = User.create(:first_name => 'Vidhur', :last_name => 'Vohra', :gt_user_id => 'darkzeroman', :password => 'password',
 	:email => "blah@lol.com", :gt_num_id => "9023", :is_admin => true)
